...
int main (int argc, const char * argv[]) 
{
	...
	ofstream triples("tree.nt");
  	...
  	forall_nodes(v,G)
  	{
  		...
  		if (G.parent(v) != v)
		{
			triples << "<http://www.departments.bucknell.edu/biology/resources/msw3/browse.asp?id=" << id[v] << ">";
			triples << " " << "<http://schema.org/parentTaxon> ";
			triples << " " << "<http://www.departments.bucknell.edu/biology/resources/msw3/browse.asp?id=" << id[G.parent(v)] << ">";
			triples << " . " << endl;
 		}
 		
 		// visitation numbers
		triples << "<http://www.departments.bucknell.edu/biology/resources/msw3/browse.asp?id=" << id[v] << ">";
		triples << " " << "<http://www.w3.org/1999/02/22-rdf-syntax-ns#first> ";
		triples << " " << "\"" << left_visitation[v] << "\"" << "^^<http://www.w3.org/2001/XMLSchema#integer>";
		triples << " . " << endl;
		
		triples << "<http://www.departments.bucknell.edu/biology/resources/msw3/browse.asp?id=" << id[v] << ">";
		triples << " " << "<http://www.w3.org/1999/02/22-rdf-syntax-ns#rest> ";
		triples << " " << "\"" << right_visitation[v] << "\"" << "^^<http://www.w3.org/2001/XMLSchema#integer>";
		triples << " . " << endl;
  	}
	triples.close();
